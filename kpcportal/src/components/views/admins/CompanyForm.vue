    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb font-kulen">
                ...
                <li class="breadcrumb-item active" aria-current="page">ក្រុមហ៊ុន</li>
            </ol>
        </nav>
        <div class="content">
            <div class="card card-x">
                <div class="card-header">
                    <div class="toolbar">
                        <button to="/admin/employee/create" class="btn btn-outline-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i> រក្សាទុក</button>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                        <label class="label-control kh">ឈ្មោះសហគ្រាស ឬគ្រឹះស្ថាន</label>
                                        <div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="label-control kh">ប្រភេទសហគ្រាស</label>
                                        <div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="label-control kh">ឈ្មោះម្ចាស់សហគ្រាស</label>
                                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="label-control kh">សញ្ជាតិ</label>
                                        <div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="label-control kh">លេខទូរសព្ទ</label>
                                        <div><input type="text" class="form-control form-control-sm kh" v-model="model.Phone" /></div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="" class="label-control kh">អ៊ីម៉ែល</label>
